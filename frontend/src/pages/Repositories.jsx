    ...
    return (
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {[...Array(4)].map((_, index) => (
            <div key={index} className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 overflow-hidden animate-pulse">
    ...
    return (
      <div className="max-w-7xl mx-auto">
        ...
        <div className="rounded-lg bg-red-50 p-6 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-800 dark:text-gray-100">Error loading repositories</h3>
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <div className="relative w-full sm:w-64">
          ...
          <input
            type="text"
            className="block w-full rounded-md border-0 py-1.5 pl-10 pr-3 text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm"
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-8 text-center">
          ...
          {searchQuery ? (
            <>
              ...
              <p className="text-gray-500 dark:text-gray-400">No repositories match your search criteria</p>
            </>
          ) : (
            <>
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-1">No repositories yet</h3>
              <p className="text-gray-500 dark:text-gray-400">When repositories are added, they'll appear here</p>
            </>
          )}
        </div>
      ) : (
          ...
          {filteredRepositories.map(repo => {
            ...
            return (
              <Link 
                ...
                className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 overflow-hidden hover:shadow-md transition-shadow group"
              >
                <div className="px-6 py-5">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center group-hover:text-indigo-600 transition-colors">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm mb-4 line-clamp-2">{repo.summary}</p>
                  ...
                  <div className="flex justify-between items-center mt-4 pt-3 border-t border-gray-100 dark:border-slate-700 text-xs text-gray-500 dark:text-gray-400">
